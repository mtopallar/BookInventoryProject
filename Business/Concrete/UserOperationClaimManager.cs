...
namespace Business.Concrete
{
    public class UserOperationClaimManager : IUserOperationClaimService
    {
        ...
        private IResult ThisUserHasAdminRoleAlready(UserOperationClaim userOperationClaim)
        {
            ...
            // bu metod admin yetkisine sahip bir kullanıcıya gereksiz olduğu için diğer rollerin eklenmemesini sağlayan -yani bunun kontrolünü yapan- metod. if deki && userOperationClaim.OperationClaimId != getUserRole.Id kısmı admin olan bir kullanıcıdan user rolü yanlışlıkla silinirse onu tekrar ekleyebilmek için. Aksi halde user rolünü eklemeye kalkarken bu kullanıcı zaten admin yetkisine sahip şeklinde hata döndürür.
